...
let ``Progression intervals`` () =
    ...
    let expected = [
        "#0 Time: 00:04:40, Distance: 1.00km, Pace: 4:40/km";
        "#1 Time: 00:04:35, Distance: 1.00km, Pace: 4:35/km";
        "#2 Time: 00:04:30, Distance: 1.00km, Pace: 4:30/km";
        "#3 Time: 00:04:25, Distance: 1.00km, Pace: 4:25/km";
        "#4 Time: 00:04:20, Distance: 1.00km, Pace: 4:20/km";
        "#5 Time: 00:04:15, Distance: 1.00km, Pace: 4:15/km";
        "#6 Time: 00:04:10, Distance: 1.00km, Pace: 4:10/km";
        "#7 Time: 00:04:05, Distance: 1.00km, Pace: 4:05/km";
        "#8 Time: 00:04:00, Distance: 1.00km, Pace: 4:00/km";
        "#9 Time: 00:03:55, Distance: 1.00km, Pace: 3:55/km";
    ]
    input |> parseOk |> should equal expected
...
let ``Sum intervals`` () =
    ...
    let expected = [
        "#0 Time: 00:05:00, Distance: 1.00km, Pace: 5:00/km";
        "#1 Time: 00:12:00, Distance: 2.00km, Pace: 6:00/km";
        "#2 Time: 00:05:00, Distance: 1.00km, Pace: 5:00/km";
    ]
    input |> parseOk |> should equal expected
...
let ``Repetition intervals`` () =
    ...
    let expected = [
        "#0 Time: 00:02:00, Distance: 400m, Pace: 5:00/km";
        "#1 Time: 00:01:00, Distance: 100m, Pace: 10:00/km";
        "#2 Time: 00:02:00, Distance: 400m, Pace: 5:00/km";
        "#3 Time: 00:01:00, Distance: 100m, Pace: 10:00/km";
        "#4 Time: 00:02:00, Distance: 400m, Pace: 5:00/km";
        "#5 Time: 00:01:00, Distance: 100m, Pace: 10:00/km";
        "#6 Time: 00:02:00, Distance: 400m, Pace: 5:00/km";
        "#7 Time: 00:01:00, Distance: 100m, Pace: 10:00/km";
    ]
    input |> parseOk |> should equal expected
...
let ``Sample workout warmup plus progression`` () =
    ...
    let expected = [
        "#0 Time: 00:09:00, Distance: 1.00km, Pace: 9:00/km";
...
let ``Sample workout warmup plus repetitions plus cooldown`` () =
    ...
    let expected = [
        "#0 Time: 00:18:00, Distance: 2.00km, Pace: 9:00/km";
        "#1 Time: 00:04:00, Distance: 1.00km, Pace: 4:00/km";
        "#2 Time: 00:02:00, Distance: 200m, Pace: 10:00/km";
        "#3 Time: 00:04:00, Distance: 1.00km, Pace: 4:00/km";
        "#4 Time: 00:02:00, Distance: 200m, Pace: 10:00/km";
        "#5 Time: 00:04:00, Distance: 1.00km, Pace: 4:00/km";
        "#6 Time: 00:02:00, Distance: 200m, Pace: 10:00/km";
        "#7 Time: 00:04:00, Distance: 1.00km, Pace: 4:00/km";
        "#8 Time: 00:02:00, Distance: 200m, Pace: 10:00/km";
        "#9 Time: 00:04:00, Distance: 1.00km, Pace: 4:00/km";
        "#10 Time: 00:02:00, Distance: 200m, Pace: 10:00/km";
        "#11 Time: 00:04:00, Distance: 1.00km, Pace: 4:00/km";
        "#12 Time: 00:02:00, Distance: 200m, Pace: 10:00/km";
        "#13 Time: 00:14:00, Distance: 2.00km, Pace: 7:00/km";
    ]
    input |> parseOk |> should equal expected
